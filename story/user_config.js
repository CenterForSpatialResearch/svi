...
function configureStory(){
    config = {
        ...
        chapters: [
            {
                id: 'start',
                title: 'The CDC\'s Social Vulnerability Index is one of the many ways to measure vulnerability',
                image: '',
                description: "The SVI<sup>*</sup> uses 15 demographic data points from the American Community Survey <sup>*</sup> to provide a vulnerability score for each county and census tract in the country. Here we are looking at data on the county level."
                +"<div id=\"ipAddress\">"
 ...
 //                    }
    ...
    var newChapter = {
        id: 'percentile',
        title: 'How does your county compare to the rest of the country?',
        image: '',
